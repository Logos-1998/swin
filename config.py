...
_C.DATA.MEAN = [0.11899374425411224, 0.11899374425411224, 0.11899374425411224]
_C.DATA.STD = [0.1225612461566925, 0.1225612461566925, 0.1225612461566925]

# [新增] 临床数据归一化参数 (来自 csv_get.py 的统计结果)
# 顺序: Age, Height, Weight
_C.DATA.TABULAR_MEAN = [68.16534574995046, 161.99546760451753, 63.524801862492566]
_C.DATA.TABULAR_STD  = [9.927926918133261, 8.244953649169963, 11.02788103797]
